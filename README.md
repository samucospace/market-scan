# Market Scan — Global Macro & Swing Trading Platform

Personal daily-refresh dashboard: institutional macro regime analysis, early warning anomaly radar, and algorithmic swing trade generator across a multi-asset universe (FX, Equities, Commodities, US Treasury Yields, and Sector ETFs).
...
1. **Top KPI Header**:
   ...
   - **Early Warning Counter & Market Freshness Badge**.
...
4. **⚡ Early Signs & Inflection Radar**:
